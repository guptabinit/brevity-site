  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container-custom">
          <SectionHeading
            title="Why Choose Our Tech Stack"
            subtitle="We carefully select technologies that provide the best balance of performance, scalability, and developer experience."
            centered={true}
          />
            ...
            {[
              {
                title: "Performance",
                description:
                  "Our tech stack is optimized for speed and efficiency, ensuring your applications load quickly and respond instantly to user interactions.",
                icon: "⚡",
              },
              {
                title: "Scalability",
                description:
                  "As your business grows, your applications need to grow with it. Our tech stack is designed to scale seamlessly from startup to enterprise.",
                icon: "📈",
              },
              {
                title: "Security",
                description:
                  "We prioritize security at every level of the stack, implementing best practices and staying up-to-date with the latest security standards.",
                icon: "🔒",
              },
              {
                title: "Maintainability",
                description:
                  "Clean code, comprehensive documentation, and modern development practices make it easy to maintain and extend your applications.",
                icon: "🔧",
              },
              {
                title: "Cost-Effectiveness",
                description:
                  "Our tech stack includes many open-source technologies, reducing licensing costs while maintaining enterprise-grade quality.",
                icon: "💰",
              },
              {
                title: "Future-Proof",
                description:
                  "We stay at the forefront of technology trends, ensuring your applications remain relevant and competitive for years to come.",
                icon: "🚀",
              },
            ].map((benefit, index) => (
              <motion.div
